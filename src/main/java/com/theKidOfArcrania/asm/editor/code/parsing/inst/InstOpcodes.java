...
public enum InstOpcodes
{
    ...
    INST_JSR(JSR, JMP_INST_SPEC), INST_L2D(L2D, ZERO_OP_INST_SPEC), INST_L2F(L2F, ZERO_OP_INST_SPEC),
    INST_L2I(L2I, ZERO_OP_INST_SPEC), INST_LADD(LADD, ZERO_OP_INST_SPEC), INST_LALOAD(LALOAD, ZERO_OP_INST_SPEC),
    INST_LAND(LAND, ZERO_OP_INST_SPEC), INST_LASTORE(LASTORE, ZERO_OP_INST_SPEC), INST_LCMP(LCMP, ZERO_OP_INST_SPEC),
    INST_LCONST_0(LCONST_0, ZERO_OP_INST_SPEC), INST_LCONST_1(LCONST_1, ZERO_OP_INST_SPEC), INST_LDC(LDC, LDC_INST_SPEC),
    ...
    INST_RET(RET, VAR_INST_SPEC), INST_RETURN(RETURN, ZERO_OP_INST_SPEC), INST_SALOAD(SALOAD, ZERO_OP_INST_SPEC),
